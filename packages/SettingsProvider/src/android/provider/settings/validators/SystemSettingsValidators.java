...
public class SystemSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(System.SYNTHOS_VOLUME_PANEL_PADDING_TOP, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(System.SYNTHOS_VOLUME_PANEL_PADDING_BOTTOM, ANY_INTEGER_VALIDATOR);
    }
}
